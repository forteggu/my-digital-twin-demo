...
Write-Host "[*] Deploying notifications manager server service ..."
kubectl apply -f .\notifications_manager\server.yaml
Write-Host "[*] Deploying notifications log visualizer service ..."
kubectl apply -f .\notifications_manager\visualizer.yaml
